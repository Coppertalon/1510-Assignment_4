...
from location_descriptions import location_difficult_8


class Test(TestCase):
    # testing the combat section would involve entering the gameplay loop and is too hard to test
    @patch('builtins.input', side_effect=[''])
    def test_location_difficult_8(self, mock_input):
        maps = {"map_visual": [["*", "*", "*", "*", "*"],
                               ["*", "*", "*", "*", "*"],
                               ["*", "*", "*", "*", "*"],
                               ["*", "*", "*", "*", "*"],
        ...
        player_character = {"name": "test",
                            ...
                            "take_away": 0,
                            "re_roll": 0}
        output = location_difficult_8(maps, player_character, True)
